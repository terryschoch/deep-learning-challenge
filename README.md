...
- **Model 1 (nn):**
    ...
    - Accuracy Score: **72.9%**
    - Loss Score: **55.7%**
    - !(https://github.com/terryschoch/deep-learning-challenge/blob/main/Images/nn_accuracy.png)
    - !(https://github.com/terryschoch/deep-learning-challenge/blob/main/Images/nn_loss.png)
...
- **Model 2 (opta):**
    ...
    - Accuracy Score: **72.9%**
    - Loss Score: **55.6%**
    - !(https://github.com/terryschoch/deep-learning-challenge/blob/main/Images/Opta_accuracy.png)
    - !(https://github.com/terryschoch/deep-learning-challenge/blob/main/Images/Opta_loss.png)
...
- **Model 3 (optb):**
    ...
    - Accuracy Score: **73.1%**
    - Loss Score: **57%**
    - !(https://github.com/terryschoch/deep-learning-challenge/blob/main/Images/optb_accuracy.png)
    - !(https://github.com/terryschoch/deep-learning-challenge/blob/main/Images/optb_loss.png)
...
- **Model 4 (optc):**
    ...
    - Accuracy Score: **73%**
    - Loss Score: **58.5%**
    - !(https://github.com/terryschoch/deep-learning-challenge/blob/main/Images/optc_accuracy.png)
    - !(https://github.com/terryschoch/deep-learning-challenge/blob/main/Images/optc_loss.png)
